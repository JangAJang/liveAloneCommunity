...
public class WritePostTest {
    ...
    @Test
    @DisplayName("토큰이 있고, 제목이 null일 때 400에러와 제목을 입력해야함을 알려준다.")
    public void writePostTest_Fail_Null_Title() throws Exception{
        //given
        WritePostRequestDto writePostRequestDto = WritePostRequestDto.builder()
                .category(Category.COOKING)
                .content("내용").build();
    ...
    @Test
    @DisplayName("토큰이 있고, 제목이 공백 문자열일 때 400에러와 제목을 입력해야함을 알려준다.")
    public void writePostTest_Fail_Blank_Title() throws Exception{
        //given
        WritePostRequestDto writePostRequestDto = WritePostRequestDto.builder()
                .category(Category.COOKING)
                .title("   ")
    ...
    @Test
    @DisplayName("토큰이 있고, 내용이 null일 때 400에러와 제목을 입력해야함을 알려준다.")
    public void writePostTest_Fail_Null_Content() throws Exception{
        //given
        WritePostRequestDto writePostRequestDto = WritePostRequestDto.builder()
                .category(Category.COOKING)
                .title("제목").build();
    ...
    @Test
    @DisplayName("토큰이 있고, 내용이 빈 문자열일 때 400에러와 제목을 입력해야함을 알려준다.")
    public void writePostTest_Fail_Empty_Content() throws Exception{
        //given
        WritePostRequestDto writePostRequestDto = WritePostRequestDto.builder()
                .category(Category.COOKING)
                .title("제목")
    ...
    @Test
    @DisplayName("토큰이 있고, 내용이 공백 문자열일 때 400에러와 제목을 입력해야함을 알려준다.")
    public void writePostTest_Fail_Blank_Content() throws Exception{
        //given
        WritePostRequestDto writePostRequestDto = WritePostRequestDto.builder()
                .category(Category.COOKING)
                .title("제목")
