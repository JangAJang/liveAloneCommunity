...
public class RegisterTest {
    ...
    @Test
    @DisplayName("이미 사용중인 이메일로 회원가입하려고 하면 400에러를 반환한다. ")
    public void registerTest_FAIL_EMAIL_IN_USE() throws Exception{
        //given
        createFormerMember();
        RegisterRequestDto registerRequestDto = RegisterRequestDto.builder()
                .username("test")
    ...
    @Test
    @DisplayName("입력하려는 값중 null이 존재하면 400에러륿 반환한다.")
    public void registerTest_NULL() throws Exception{
        //given
        createFormerMember();
        RegisterRequestDto registerRequestDto = RegisterRequestDto.builder()
                .nickname("test")
        ...
        mvc.perform(MockMvcRequestBuilders.post("/api/auth/register")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.success").value(false))
                .andExpect(MockMvcResultMatchers.jsonPath("$.code").value(400))
                .andExpect(MockMvcResultMatchers.jsonPath("$.result.failMessage").value("아이디를 입력해주세요."))
                .andDo(MockMvcResultHandlers.print());
    }

    @Test
    @DisplayName("입력하려는 값중 공백문자열이 존재하면 400에러륿 반환한다.")
    public void registerTest_BLANK() throws Exception{
        //given
        createFormerMember();
        RegisterRequestDto registerRequestDto = RegisterRequestDto.builder()
                .username("   ")
    ...
    @Test
    @DisplayName("입력하려는 값중 내용없는 문자열이 존재하면 400에러륿 반환한다.")
    public void registerTest_EMPTY() throws Exception{
        //given
        createFormerMember();
        RegisterRequestDto registerRequestDto = RegisterRequestDto.builder()
                .username("")
