...
public class AuthController {
    ...
    public Response register(@RequestBody @Valid final RegisterRequestDto registerRequestDto) {
    ...
    public Response logIn(@RequestBody @Valid final LogInRequestDto logInRequestDto, final HttpServletResponse response) {
    ...
    public Response kakaoCallBack(@RequestParam("code") final String code, final HttpServletResponse response) {
    ...
    public Response reissue(@RequestBody final ReissueRequestDto reissueRequestDto) {
